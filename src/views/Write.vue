	...
	<div class="bl-container bl-df-jcenter con-img background-m">
		<div class="bl-col-8 left">
			<div msgborder class="say-box">
				...
				<br>
				<br>
				<textarea msgborder placeholder="这人很懒啥都没写=v=" type="text" v-model="articleAddDto.content" ></textarea>
				<textarea msgborder placeholder="请写简介哦" type="text" v-model="articleAddDto.summary" ></textarea>
				<input msgboard type="button"  value="上传" @click=
				"connect(articleAddDto)" class="btn-n"
				 :class="{'shade':istrue === true}"
				 						 @mouseenter="stop"
				 						   @mouseleave="go"/>
			</div>
		</div>
...
<style>
	/* .background-m{
		background: url(https://www.mapblog.cn/img/mainBg2.jpg);
	} */
	.page .btn-bg {
